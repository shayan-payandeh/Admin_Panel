...
export default class ShopLevelAdd extends Component {
    ...
    async componentDidMount() {
        ...
        const response  = await axios.post('http://192.168.1.116:5000/api/shop-category-sell/list',this.state.body)
    ...
    handleChange = async () =>{
        ...
        const response = await axios.post('http://192.168.1.116:5000/api/shop-category-sell/edit',{
            count : 0 ,
            index : 10,
      ...
      window.location = '/shopping/shopsell'
    }
    render() {
